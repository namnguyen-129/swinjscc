...
from timm.layers import DropPath, to_2tuple, trunc_normal_  # Updated import
...
def window_partition(x, window_size):
    ...
    """
    # print("Window partitionirtetreng x:", window_size)

    # print("Input x.shape:", x.shape)
    B, H, W, C = x.shape
    if H % window_size != 0 or W % window_size != 0:
        raise ValueError(f"Height ({H}) and Width ({W}) must be divisible by window_size ({window_size})")
